...
class mapDropdown extends React.Component {
  ...
  componentDidMount() {
    this.props.fetchTopCities().then(() => this.props.fetchTopCountries());
  }
      ...
      <main className="the-atlas">
        <div className="atlas-holder">
          <p className="tag-line">
            <span id="map-dropdown-discover-holder">
              <span id="map-dropdown-discover">Discover</span>
            </span>{" "}
            the world's most hidden places
          </p>
        </div>
        <section className="map-dropdown-holder">
          ...
          <section className="map-lists-holder">
            <section className="country-holder">
              ...
              <hr className="map-label-divider" />
            ...
            <section className="city-holder">
              ...
              <div className="city-list-holder">
                <ul className="city-list-one">{this.firstThirdCities()}</ul>
                <ul className="city-list-two">{this.secondThirdCities()}</ul>
                <ul className="city-list-three">{this.thirdThirdCities()}</ul>
              </div>
            </section>
          </section>
        </section>
