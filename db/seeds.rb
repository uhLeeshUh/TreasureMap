...
City.create!([
  ...
  {name: 'Brooklyn, NY', country_id: Country.find_by(name: "USA").id},
  ...
  {name: 'Quito', country_id: Country.find_by(name: "Ecuador").id},
  {name: 'Stolkholm', country_id: Country.find_by(name: "Sweden").id},
  {name: 'Taipei', country_id: Country.find_by(name: "Taiwan").id},
  {name: 'Hong Kong', country_id: Country.find_by(name: "Hong Kong").id},
  {name: 'Singapore', country_id: Country.find_by(name: "Singapore").id},
  {name: 'Mexico City', country_id: Country.find_by(name: "Mexico").id},
  {name: 'Tokyo', country_id: Country.find_by(name: "Japan").id},
  {name: 'Sparta', country_id: Country.find_by(name: "Greece").id},
...
#6, 3
  { name: "New York Marble Cemetery",
    ...
    body: "The New York Marble Cemetery was created in response to the yellow fever outbreak that started near the Trinity Church cemetery. The Common Council ruled to ban earth graves in lower Manhattan to limit the spread of the Caribbean-born disease. Instead, marble vaults were built ten feet underground.
    Names from the original vault owners are engraved on marble tablets that are set into the stone cemetery walls. These tablets act as a guide for the location of the vaults underground. In order to access a vault, a stone slab has to be exposed by digging by hand, that is then lifted off to expose the entry shaft going down to the slate doors. Some of the vaults also require a key to open the door.
    Over 150 vaults made from solid white Tuckahoe marble are located just below the half-acre grassy space in the interior of the East Village block. The New York Marble Cemetery is the oldest public non-sectarian cemetery in the city. After being established in 1830, it held most of its burials between 1830 and 1870, and took in its last deceased in 1937.
    In the middle of the East Wall, there is a large marble plaque that is now illegible, but used to state: “New York Marble Cemetery - A Place of Interment for Gentlemen.” However most of those buried in the cemetery were not members of the high society, but were merchants, lawyers, and ship owners. The Dead House that temporarily held remains used to be at the southwest corner of the cemetery, until it was removed in 1955.
    It was located right over the entry to Vaults 51 and 52, so that Perkins Nichols, the cemetery’s developer and organizer, would have easy access to his Vault 51. When rural cemeteries, like Green-Wood Cemetery in Brooklyn, became fashionable in the late 1830s, about one fourth of the people buried in the Marble Cemetery were excavated and reinterred elsewhere. Much of the cemetery has since deteriorated due to the delicate nature of the soft marble and one of the walls is missing. Nonetheless, the cemetery has remained there, tucked away in Manhattan for over 180 years, more than can be said about much heartier structures.",
    lat: 40.7256,
    lng: -73.9909,
    author_id: User.find_by(username: "Yiayia").id,
    city_id: City.find_by(name: "New York, NY").id
...
#7, 4
  { name: "Showmen's Rest",
    ...
    body: "Although many circuses have rested in Hugo, its current winter denizens are Carson & Barnes Circus and its sister circus, Kelly Miller. When Kelly died in 1960, his brother D.R. Miller purchased a section in the town cemetery to memorialize him and other circus performers.
...
#8, 5
  { name: "La Isla de las Muñecas (Island of the Dolls)",
    ...
    body: "Over fifty years ago, Don Julian Santana left his wife and child and moved onto an island on Teshuilo Lake in the Xochimilco canals. According to some, a young girl actually drowned in the lake, while most others, including his relatives, say Don Julian Santana merely imagined the drowned girl.
    Regardless, Don Julian Santana devoted his life to honoring this lost soul in a unique, fascinating, and—for some—unnerving way: he collected and hung up dolls by the hundreds. Eventually, Don Julian transformed the entire island into a kind of bizarre, (for some) horrifying, doll-infested wonderland. Don Julian Santana began collecting lost dolls from the canals and the trash near his island home. He is also said to have traded produce he grew to locals for more dolls.
    Santana did not clean up the dolls or attempt to fix them, but rather put them up with missing eyes and limbs, covered in dirt, and generally in whatever ramshackle state he found them in. Even when dolls arrived in good shape, the wind and weather turned them into cracked and distorted versions of themselves. Don Julian also kept his cabin filled with the dolls, which he dressed in headdresses, sunglasses, and other accoutrement.
...
#9, 5
  { name: "Naki Sumo Baby Crying Contest",
    ...
    body: "The traditional festival takes place at the Sensoji Temple in Tokyo each year, pairing up tiny little babies with a sumo wrestler who will then try to get the little guy to cry. The origins of the bizarre practice date back hundreds years to a simple proverb that states, “Naku ko wa sodatsu,” or “Crying babies grow fat.”
    The other reason behind the festival, is the belief that somehow the piercing wails work to drive off nearby demons that would otherwise bring you to harm. While neither of these claims are proven to work, that hasn’t stopped people from making their children cry in public.
    During the ceremonies, sumo wrestlers take the stage and hold up the participating babies (their parents actually brought them to this), and try to get them to start bellowing. Among the techniques used to make the babies unhappy include putting on a scary mask to freak them out and the old stand by of just yelling, “CRY! CRY! CRY!” into their little faces.
    But it’s all worth it, because if they are the best cryer, they are ensured a long, healthy life. For all the seeming cruelty of the event, it actually has a fun, jokey air as the adults seem to realize that intentionally getting kids to cry is a little goofy. The kids don’t seem to be in on the joke.",
    lat: 35.7140,
    lng: 139.7965,
    author_id: User.find_by(username: "Craig").id,
...
#12, 1
  { name: "Chairman Mao Memorial Hall",
    ...
    They viewed dozens of submissions before finally settling on the one that holds the mummified communist leader. Each one was put through the ringer as it was tested against variables like temperature, vibration, and its ability to withstand an earthquake. The building the crystal coffin and its embalmed inhabitant reside in is also impressive, especially considering it was built in only six months.
    Materials from all across China were used to make it, and 700,000 workers from different provinces, autonomous regions, and nationalities did “symbolic voluntary labor” to get it all finished. Art in and around the hall pays tribute to various revolutionary leaders.
...
#13, 1
  { name: "798 Art District",
    ...
    body: "Works from Chinese artists Ai WeiWei and Wenda Gu are flying off the shelves, and Christie’s and Sotheby’s can’t get enough. Art prices are growing even faster than China’s explosive economy, and the 798 is at the center of this boom.
    The 798 thrives on irony. Tiny shops sell kitschy Maoist junk, or T-shirts displaying “Obamao.” The greatest irony of all, though, are the buildings itself.
    The entire complex is built in a Cultural Revolution-era warehouse district, with the Moaist slogans still emblazoned in big red letters in some of the gallery spaces, urging the proletariat to work hard for Mother China. The factories give the area a gritty feel, and the district was actually almost closed by the government in 2003.
    Mao was a great patron of the arts, but he probably didn’t have this in mind. The actual district is a mixture of galleries, museums, shops, and cafes. it is large enough that it would be hard to see everything in an afternoon, but it is great for perusing and exploring. There are events and openings frequently, and you can try and check their website to see what’s happening during your visit.",
    lat: 39.9042,
    lng: 116.4074,
    author_id: User.find_by(username: "Alicia").id,
    city_id: City.find_by(name: "Beijing").id
...
#14, 1
  { name: "Great Wall of China Slide",
    ...
    body: "Millions of people dream of one day standing atop the Great Wall of China. But at the wall’s Mutianyu section, visitors have the opportunity to experience the world wonder in a much more thrilling way: by whizzing down it in a toboggan slide.
...
#20, 4
  { name: "New York Transit Museum",
    ...
    body: "Housed in the abandoned Court Street station, the museum features “Steel, Stone, and Backbone” about the building of the subways. The oldest artifacts in the museum are in the “On the Streets: Trolleys and Streetcars” section, which also describes the evolution of fuel technology in buses.
...
Image.destroy_all
# Image.create([
#   {article_id: Article.find_by(name: "Blue Flash Backyard Roller Coaster").id, image},
#   {article_id: Article.find_by(name: "Blue Flash Backyard Roller Coaster").id},
#   {article_id: Article.find_by(name: "Blue Flash Backyard Roller Coaster").id},
#   {article_id: Article.find_by(name: "Texas Eiffel Tower").id1},
#   {article_id: Article.find_by(name: "Texas Eiffel Tower").id0},
#   {article_id: Article.find_by(name: "Texas Eiffel Tower").id},
#   {article_id: 3},
#   {article_id: 4},
#   {article_id: 4},
#   {article_id: 4},
...
# Image.create([
#   {article_id: 4, image: File.new("app/assets/images/.jpg")},
...
#   {article_id: Article.find_by(name: "Texas Eiffel Tower").id0, image: File.new("app/assets/images/seed_images/isla1.jpg")},
#   {article_id: Article.find_by(name: "Texas Eiffel Tower").id1, image: File.new("app/assets/images/seed_images/mao2.jpg")},
#   ])
...
# {article_id: Article.find_by(name: "Great Wall of China Slide").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/slide2.jpg"}, #####
# {article_id: Article.find_by(name: "New York Marble Cemetery").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/nymarble2.jpeg"},#####
Image.create!([
  {article_id: Article.find_by(name: "Blue Flash Backyard Roller Coaster").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/blueflash1.png"},
  {article_id: Article.find_by(name: "Blue Flash Backyard Roller Coaster").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/blueflash2.JPG"},
  ...
  {article_id: Article.find_by(name: "Texas Eiffel Tower").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/paris1.jpeg"},
  {article_id: Article.find_by(name: "Texas Eiffel Tower").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/paris2.jpeg"},
  {article_id: Article.find_by(name: "Texas Eiffel Tower").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/paris3.jpeg"},
  {article_id: Article.find_by(name: "Tuned Mass Damper of Taipei 101").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/taipei.jpeg"},
  {article_id: Article.find_by(name: "Tuned Mass Damper of Taipei 101").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/taipei2.jpeg"},
  {article_id: Article.find_by(name: "Tuned Mass Damper of Taipei 101").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/taipei3.jpeg"},
  {article_id: Article.find_by(name: "Tuned Mass Damper of Taipei 101").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/taipei4.jpeg"},
  {article_id: Article.find_by(name: "Tuned Mass Damper of Taipei 101").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/taipei5.jpeg"},
  {article_id: Article.find_by(name: "New York Federal Gold Vault").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/gold1.jpg"},
  {article_id: Article.find_by(name: "Hare Krishna Tree").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/hare1.jpg"},
  {article_id: Article.find_by(name: "Hare Krishna Tree").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/hare2.jpg"},
  {article_id: Article.find_by(name: "Hare Krishna Tree").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/hare3.jpg"},
  {article_id: Article.find_by(name: "New York Marble Cemetery").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/marble3.jpeg"},
  {article_id: Article.find_by(name: "New York Marble Cemetery").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/marble4.jpeg"},
  {article_id: Article.find_by(name: "New York Marble Cemetery").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/marble5.jpeg"},
  {article_id: Article.find_by(name: "New York Marble Cemetery").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/nymarble1.jpeg"},
  {article_id: Article.find_by(name: "Showmen's Rest").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/hugo2.png"},
  {article_id: Article.find_by(name: "Showmen's Rest").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/hugo3.png"},
  {article_id: Article.find_by(name: "Showmen's Rest").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/hugo4.png"},
  {article_id: Article.find_by(name: "Showmen's Rest").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/hugo5.png"},
  {article_id: Article.find_by(name: "Showmen's Rest").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/showmens_rest.png"},
  {article_id: Article.find_by(name: "La Isla de las Muñecas (Island of the Dolls)").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/isla1.jpg"},
  {article_id: Article.find_by(name: "La Isla de las Muñecas (Island of the Dolls)").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/isla2.jpg"},
  {article_id: Article.find_by(name: "La Isla de las Muñecas (Island of the Dolls)").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/isla3.jpg"},
  {article_id: Article.find_by(name: "La Isla de las Muñecas (Island of the Dolls)").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/isla4.jpg"},
  {article_id: Article.find_by(name: "La Isla de las Muñecas (Island of the Dolls)").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/isla5.jpg"},
  {article_id: Article.find_by(name: "Naki Sumo Baby Crying Contest").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/sumo1.jpeg"},
  {article_id: Article.find_by(name: "Naki Sumo Baby Crying Contest").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/sumo2.jpeg"},
  {article_id: Article.find_by(name: "Naki Sumo Baby Crying Contest").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/sumo3.jpeg"},
  {article_id: Article.find_by(name: "Shanghai Marriage Market").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/marriage1.jpg"},
  {article_id: Article.find_by(name: "Shanghai Marriage Market").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/marriage2.jpg"},
  {article_id: Article.find_by(name: "Shanghai Marriage Market").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/marriage3.jpg"},
  {article_id: Article.find_by(name: "Shanghai Marriage Market").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/marriage4.jpg"},
  {article_id: Article.find_by(name: "Shanghai Marriage Market").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/marriage5.jpg"},
  {article_id: Article.find_by(name: "The Central Perk, Beijing").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/friends1.jpeg"},
  {article_id: Article.find_by(name: "The Central Perk, Beijing").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/friends2.jpeg"},
  {article_id: Article.find_by(name: "The Central Perk, Beijing").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/friends3.jpeg"},
  {article_id: Article.find_by(name: "Chairman Mao Memorial Hall").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/mao1.jpg"},
  {article_id: Article.find_by(name: "Chairman Mao Memorial Hall").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/mao2.jpg"},
  {article_id: Article.find_by(name: "Chairman Mao Memorial Hall").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/mao3.jpg"},
  {article_id: Article.find_by(name: "798 Art District").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/qi_primary.jpg"},
  {article_id: Article.find_by(name: "798 Art District").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/qi2.jpg"},
  {article_id: Article.find_by(name: "798 Art District").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/qi3.jpg"},
  {article_id: Article.find_by(name: "798 Art District").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/qi4.jpg"},
  {article_id: Article.find_by(name: "798 Art District").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/qi5.jpg"},
  {article_id: Article.find_by(name: "798 Art District").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/qijiuba1.jpg"},
  {article_id: Article.find_by(name: "Great Wall of China Slide").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/slide1.jpg"},
  {article_id: Article.find_by(name: "Great Wall of China Slide").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/slide3.jpg"},
  {article_id: Article.find_by(name: "Great Wall of China Slide").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/slide4.jpg"},
  {article_id: Article.find_by(name: "Great Wall of China Slide").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/slide5.jpg"},
  {article_id: Article.find_by(name: "The World Park").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/worldpark1.jpg"},
  {article_id: Article.find_by(name: "The World Park").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/worldpark2.jpg"},
  {article_id: Article.find_by(name: "The World Park").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/worldpark3.jpg"},
  {article_id: Article.find_by(name: "The World Park").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/worldpark4.jpg"},
  {article_id: Article.find_by(name: "The World Park").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/worldpark5.jpg"},
  {article_id: Article.find_by(name: "China Watermelon Museum").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/watermelon1.jpeg"},
  {article_id: Article.find_by(name: "China Watermelon Museum").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/watermelon2.jpeg"},
  {article_id: Article.find_by(name: "China Watermelon Museum").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/watermelon3.jpeg"},
  {article_id: Article.find_by(name: "China Watermelon Museum").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/watermelon4.jpeg"},
  {article_id: Article.find_by(name: "Harbin Ice and Snow Festival").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/harbin1.jpg"},
  {article_id: Article.find_by(name: "Harbin Ice and Snow Festival").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/harbin2.jpg"},
  {article_id: Article.find_by(name: "Harbin Ice and Snow Festival").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/harbin3.jpg"},
  {article_id: Article.find_by(name: "Harbin Ice and Snow Festival").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/harbin4.jpg"},
  {article_id: Article.find_by(name: "Harbin Ice and Snow Festival").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/harbin5.jpg"},
  ...
  {article_id: Article.find_by(name: "Rayne Frog Festival").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/frog4.jpeg"},
  {article_id: Article.find_by(name: "Rayne Frog Festival").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/frog5.jpeg"},
  {article_id: Article.find_by(name: "Sedlec Ossuary Bone Church").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/bones1.jpg"},
  {article_id: Article.find_by(name: "Sedlec Ossuary Bone Church").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/bones2.jpg"},
  {article_id: Article.find_by(name: "Sedlec Ossuary Bone Church").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/bones3.jpg"},
  ...
  {article_id: Article.find_by(name: "New York Transit Museum").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/transit1.jpg"},
  {article_id: Article.find_by(name: "New York Transit Museum").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/transit2.jpg"},
  {article_id: Article.find_by(name: "New York Transit Museum").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/transit3.jpg"},
  {article_id: Article.find_by(name: "New York Transit Museum").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/transit4.JPG"},
  {article_id: Article.find_by(name: "Fearless Girl Statue").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/girl1.jpg"},
  {article_id: Article.find_by(name: "Fearless Girl Statue").id, image: "https://s3.amazonaws.com/treasure-map-dev/images/images/000/000/girl2.jpg"},
